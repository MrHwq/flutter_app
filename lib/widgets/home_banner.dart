...
class HomeBanner<T extends BaseItem> extends StatefulWidget {
    ...
    State<StatefulWidget> createState() {
        return _BannerState<T>();
    }
}

class _BannerState<T extends BaseItem> extends State<HomeBanner> {
    int virtualIndex = 0;
    int realIndex = 1;
    ...
    _BannerState({this.isAutoScroll});
...
typedef void OnTapBannerItem(Object story);